...
$mail->Body=@"Email sent from Peddie School Computer Science Club "."at ".date("d/m/y H:i", time())."<br />
      ...
      finish your registration, please click on the following link and verify your email account."."<a href='http://peddiehacks.peddie.org/registration.php' action>Finish Registration (account info confirmation)<a>"."<hr />";
...
echo "<script type='text/javascript'>window.location.replace('http://peddiehacks.peddie.org/index.html');</script>";
die();
}