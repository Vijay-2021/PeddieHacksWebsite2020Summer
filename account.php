...
///////////////////////////////
    $link2 = mysqli_connect('localhost', 'admincs', 'T95|,!#J-C%]98r', 'Peddie_Hackathon_2020', '80');
    $query2="INSERT INTO Peddie_Hackathon(Email, TeamName, SchoolName, TeamLeader,
    TeamMember1, TeamMember2, TeamMember3, TeamMember4, PhotoPermissions) VALUES
    ...
    if(mysqli_query($link2, $query2)){
        ...
        $message=mysqli_error("$link2").mysqli_error("$query2").mysqli_error("$query3");
        echo "<script type='text/javascript'>alert($message);</script>";
        //echo "<script type='text/javascript'>window.location.replace('http://peddiehacks.peddie.org/registration.php');</script>";
        die();
        }
        mysqli_close($link2);
    }
